...
- `.github/workflows/release.yml` builds backend and frontend release artifacts on tags that match `v*`, uploads them to the workflow run, and publishes a GitHub release for tagged versions.
