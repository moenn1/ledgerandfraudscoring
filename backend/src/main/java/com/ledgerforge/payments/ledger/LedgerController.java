...
public class LedgerController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public LedgerReplayResponse replayAccount(@PathVariable UUID accountId, @RequestParam(required = false) String currency) {
        return ledgerService.replayAccount(accountId, currency);
    }
