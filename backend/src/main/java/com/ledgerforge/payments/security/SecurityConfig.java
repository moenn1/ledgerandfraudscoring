...
import com.ledgerforge.payments.common.security.DataProtectionProperties;
...
@EnableConfigurationProperties({SecurityProperties.class, DataProtectionProperties.class})
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/webhooks/callbacks/**").permitAll()
    ...
    JwtDecoder jwtDecoder(SecurityProperties properties) {
        ...
        NimbusJwtDecoder decoder = NimbusJwtDecoder
                .withSecretKey(new SecretKeySpec(oauth2.getHmacSecret().getBytes(StandardCharsets.UTF_8), "HmacSHA256"))
